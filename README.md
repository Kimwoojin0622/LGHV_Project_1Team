...
### 🙋‍♂️ 김우진
실무 데이터를 활용한 분석과 전처리 과정에서 어려움을 겪었지만, 이를 해결하며 실력이 많이 향상됨을 느꼈습니다.  
모델이 데이터를 활용해 예측하는 과정이 흥미로웠고, 프론트엔드 백엔드 AWS까지 경험하며 풀스택의 흐름을 이해할 수 있었습니다.  
이번 프로젝트를 통해 데이터 분석가로서의 자질을 갖추고 자신감을 얻었습니다.

### 🙋‍♀️ 김승휴
데이터 기반 고객 이탈 분석의 전체 흐름을 경험하며 실무 적용 가능성을 확인할 수 있었습니다.  
모델링과 대시 보드 구축 과정이 비즈니스 인사이트로 이어지는 과정이 인상적이었고, 실질적인 활용 방안을 고민해볼 수 있는 의미있는 시간이었습니다.

### 🙋‍♂️ 변수민
이번 프로젝트를 통해 멋진 팀원들과 협력하여 데이터 분석과 모델 개발 과정을 경험할 수 있었습니다.  
다양한 문제를 해결하는 과정에서 서로의 강점을 활용하고, 원활한 커뮤니케이션이 얼마나 중요한지 다시 한 번 깨닫게 되었습니다.  
앞으로도 이런 팀원들과 함께 협업해가며 나아가고 싶습니다.

### 🙋‍♀️ 이진식
프로젝트를 통해 고객 이탈 예측 모델을 구축하고, FastAPI와 React를 활용한 CRM 시스템을 개발하여 실무에서 활용 가능한 솔루션을 만들었습니다.  
데이터를 기반으로 한 전략적 의사결정의 중요성을 다시 한 번 깨닫는 계기가 되었습니다.
